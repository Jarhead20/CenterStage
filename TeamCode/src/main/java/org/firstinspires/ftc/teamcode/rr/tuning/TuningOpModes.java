...
import org.firstinspires.ftc.teamcode.commands.AprilTagLocalizerSubsystem;
        ...
        if (DRIVE_CLASS.equals(MecanumDrive.class)) {
            dvf = hardwareMap -> {
                ...
                if (md.localizer instanceof MecanumDrive.DriveLocalizer) {
                    ...
                    parEncs.add(dl.par);
                    perpEncs.add(dl.perp);
                } else if (md.localizer instanceof AprilTagLocalizerSubsystem) {
                    AprilTagLocalizerSubsystem dl = (AprilTagLocalizerSubsystem) md.localizer;
                } else {
